# RailsAdmin config file. Generated on April 22, 2012 11:19
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Ruby Tuesday', 'Admin']
  ...
  # config.excluded_models = [Party, User]

  # Add models here if you want to go 'whitelist mode':
  # config.included_models = [Party, User]
  ...
  # All fields marked as 'hidden' won't be shown anywhere in the rails_admin unless you mark them as visible. (visible(true))
   ...
   config.model Party do
     ...
     # Found columns:
       ...
       configure :presenter, :string
       configure :date, :string
       configure :address, :string
       configure :introduction, :text   #   # Sections:
     list do
       field :location
       field :topic
       field :date
