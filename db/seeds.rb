...
User.create!(nickname: 'zernel', email: 'admin@ruby-tuesday.com', password: '123456', password_confirmation: '123456')
...
5.times do
  ...
  Party.create!(location: '北京', topic: 'Ruby Tuesday 第0场', date: '2012-2-21', address: '北京贝塔咖啡（BetaCafe），位于中关村原第三极一层', presenter: 'tualatrix', introduction: '虽然还是Ruby菜鸟，但是我想集结其他一样对Ruby感兴趣的朋友，一起交流，一起进步。正巧已经联系到两个朋友，因此就直接决定订在明天晚上进行一个Ruby Tuesday聚会。')
